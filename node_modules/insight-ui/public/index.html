...
<head>
  <base href="/" />
	...
	<title data-ng-bind="$root.title + $root.titleDetail + ' | Fujicoin Insight'">Fijicoin Insight</title>
	<meta name="keywords" content="fujicoins, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
	<meta name="description" content="Fujicoin Insight. View detailed information on all fujicoin transactions and block. {{ $root.title + $root.titleDetail }}">
