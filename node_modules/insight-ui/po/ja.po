...
#: public/views/messages_verify.html
msgid "Fujicoin comes with a way of signing arbitrary messages."
msgstr "Fujicoinには任意のメッセージを署名する昨日が備わっています。"

#: public/views/status.html
msgid "Fujicoin node information"
msgstr "Fujicoinノード情報"
...
msgid ""
"Can't connect to fujicoind to get live updates from the p2p network. (Tried "
"connecting to fujicoind at {{host}}:{{port}} and failed.)"
msgstr ""
"P2Pネットワークからライブ情報を取得するためにfujicoindへ接続することができませ"
...
#: public/views/status.html
msgid "Last Block Hash (Fujicoind)"
msgstr "直前のブロックのハッシュ値 (Fujicoind)"
...
"        the Fujicoin network."
msgstr ""
"このフォームでは、16進数フォーマットの生のトランザクションをFujicoinネットワー"
"ク上に配信することができます。"

#: public/views/messages_verify.html
msgid ""
"This form can be used to verify that a message comes from\n"
"        a specific Fujicoin address."
msgstr ""
"このフォームでは、メッセージが特定のFujicoinアドレスから来たかどうかを検証する"
"ことができます。"
